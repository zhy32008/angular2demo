...
@NgModule({
    ...
    declarations: [ AppComponent,HeroDetailComponent],//the view classes that belong to this module. angular has three kinds of view classes:components,directives,and pipes.
